...
interface XrdApi {
    ...
    /**
     * Serve a HashMap of PlayerUpdate, using the steamUserId as key
     *
     * @return a Set of the Xrd lobby's currentOverlay active players and their update
     */
    fun getXrdData(): Set<PlayerUpdate>
}
