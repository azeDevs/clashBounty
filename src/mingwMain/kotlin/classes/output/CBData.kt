...
//import classes.session.logWarn
//
...
//        else if (!xrdApi.isXrdConnected()) {
//            val connected = xrdApi.connectToXrd()
//            if (connected) {
//                var pdset = xrdApi.getXrdData()
//                logInfo("XrdData ${pdset.isEmpty()}")
//                for (pd in pdset.iterator()) {
//                    logInfo("Display Name: ${pd.displayName}")
//                    logInfo("Character ID: 0x${pd.characterId.toString(16)}")
//                }
//            }
